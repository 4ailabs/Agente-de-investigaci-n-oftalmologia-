...
const ExplanationModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className={`bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-hidden mx-4 transform transition-all duration-300 ${
      ...
      >
        ...
        <div className="overflow-y-auto p-8 scrollbar-thin scrollbar-thumb-slate-400 scrollbar-track-slate-200" style={{ maxHeight: 'calc(95vh - 100px)' }}>
          <DesktopContent />
        </div>
      </div>
    </div>
