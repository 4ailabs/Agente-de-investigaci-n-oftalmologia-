        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-800">4 ailabs</h3>
                <p className="text-slate-500 text-sm">Desarrollo de IA Médica</p>
              </div>
            </div>
          ...
          {/* Technology Section */}
          <div className="md:col-span-1">
            <h4 className="text-lg font-semibold mb-4 text-slate-800">Tecnología</h4>
          ...
          {/* Contact Section */}
          <div className="md:col-span-1">
            <h4 className="text-lg font-semibold mb-4 text-slate-800">Desarrollado por</h4>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-slate-800">4 ailabs</p>
                  <p className="text-slate-500 text-sm">Laboratorio de IA</p>
                </div>
              </div>
              <div className="pt-2">
